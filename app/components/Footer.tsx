...
import HoverDevCards from "./FooterCard";
const Footer = () => {
    ...
    return (
        <footer className="text-black bg-gray-200 shadow-red-500 border-spacing-0 border-red ">
            <div className="max-w-lg sm:mx-auto sm:text-center">
            <Image className="h-36 py-10" src={logo} alt="logo"  />
                <p className=" mt-10 text-[15px] text-center font-sans">
                Thank you for being a part of the Bubbles community. We wish you all the best in your journey to find meaningful connections. If you have any questions or need assistance, our support team is here to help. Stay safe, have fun, and keep those bubbles of love alive!
                </p>
            </div>
            <HoverDevCards/>
            <div className="mt-8 items-center justify-between sm:flex">
                <div className="mt-4 sm:mt-0">
                © 2023 Bubbles. All rights reserved
                </div>
