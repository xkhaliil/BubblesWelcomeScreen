export default () => {
    ...
    const testimonials = [
        {
            avatar: "https://scontent.ftun8-1.fna.fbcdn.net/v/t39.30808-6/294218982_3178343435827028_6895677572755314529_n.jpg?_nc_cat=101&ccb=1-7&_nc_sid=5f2048&_nc_ohc=VEMRlkFJCJ8AX8oTYdl&_nc_ht=scontent.ftun8-1.fna&oh=00_AfCy_UnI9Elg7PrtTglF2RY_cEhDfDhLZ0z8V8c06SWB8g&oe=654AB930",
            name: "Youssef Hammemy ",
            title: "Music Producer",
            quote: "Bubbles adds a fun twist to dating. It's not just about finding a partner; it's about enjoying the journey. The app's chat features are engaging, and I've met some incredible individuals here. Highly recommended!"
        },
        {
            avatar: "https://scontent.ftun8-1.fna.fbcdn.net/v/t39.30808-6/264207818_5276768099018940_7440777234317335382_n.jpg?_nc_cat=108&ccb=1-7&_nc_sid=5f2048&_nc_ohc=PCU1U96C1JoAX8ezAeB&_nc_ht=scontent.ftun8-1.fna&oh=00_AfABGKaqUxueqVQQpwEeh6_o4yNda5HbZr_HnnzIHd7hqw&oe=654A8829",
            name: "Firas Ftiti ",
            title: "Software engineer",
            quote: "I was a bit skeptical about dating apps, but Bubbles pleasantly surprised me. I've made some great connections and even formed lasting friendships. It's a fantastic platform to meet like-minded people."
        },
        {
            avatar: "https://scontent.ftun7-1.fna.fbcdn.net/v/t39.30808-6/378394963_1384130895508195_6190041893450504943_n.jpg?_nc_cat=102&ccb=1-7&_nc_sid=5f2048&_nc_ohc=bzIvurCbLuIAX8O71l_&_nc_ht=scontent.ftun7-1.fna&oh=00_AfCHHRgdTvU-Q61e3MlI1pUbXj_AUVUzXM483qS-FRizwg&oe=654A17ED",
            name: "Fatma Hattab ",
            title: "Student",
            quote: "Bubbles has completely changed my dating experience. I met my perfect match here, and we've been inseparable ever since. The app's user-friendly design and matching algorithms are top-notch. I couldn't be happier!"
        },
    ]
        ...
        <section className="relative py-14">
            <div className="relative z-10 max-w-screen-xl mx-auto px-4 md:px-8">
                <div className="max-w-xl sm:text-center md:mx-auto">
                    ...
                    Discover real stories of love and connection straight from our users. See how Bubbles has made a difference in their lives, and let their experiences inspire your own journey.                    </p>
                </div>
                <div className="mt-12">
            ...
            <div className="absolute top-0 w-full h-[350px]" style={{ background: "linear-gradient(152.92deg, rgba(255, 0, 0, 0.3) 4.54%, rgba(255, 0, 0, 0.25) 34.2%, rgba(255, 0, 0, 0.2) 77.55%)" }}></div>
